...
<<Iorio.RankMerging>>=
MergingSet <- Iorio.RankMerging(exampleSet,"Spearman")
show(MergingSet)
@
...
<<SignatureDistance>>=
SignatureDistance(exampleSet,SignatureLength=250,MergingMethod="Iorio",
...
<<Iorio.RankMerging>>=
IorioMergingSet <- Iorio.RankMerging(exampleSet,"Spearman")
...
<<Pihur.RankMerging>>=
PihurMergingSet <- Pihur.RankMerging(exampleSet[1:12],"Spearman")
